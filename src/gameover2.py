...
class Gameover2(cocos.layer.ColorLayer):
    def __init__(self):
        super(Gameover2, self).__init__(200, 235, 235, 200, 400, 300)
        ...
        self.score = cocos.text.Label('',
                                      ...
                                      font_size=36,
                                      color=define.MAROON)
        self.score.position = 280, 195
        self.add(self.score)

        text = cocos.text.Label('WORDS COVERD: ',
                                font_name='SimHei',
                                font_size=24,
                                color=define.MAROON)
